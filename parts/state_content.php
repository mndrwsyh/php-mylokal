      ...
      <div class="ms-5 mt-5 text-secondary">
        ...
        <div class="row pt-3">
          ...
          <?php foreach ($posts as $post): ?>
            <?php 
            $sql = "SELECT * FROM liked WHERE users_id = :users_id AND posts_id = :posts_id";
          ...
          <div class="col-3 mb-4">
              ...
              <!--end like button-->
              <img src="<?= $post["image"];?>" class="card-img-top" alt="Activities Image" style="height:250px;">
              <div class="card-body"> 
                  ...
                  <div class="d-flex justify-content-start align-items-start gap-2"> 
                          <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#actEditModal-<?php echo $post["id"]; ?>">Edit</button> 


                          <!--edit user modal-->
                          <div
                            class="modal fade"
                            id="actEditModal-<?php echo $post["id"]; ?>"
                            tabindex="-1"
                                    ...
                                    <form action="/post/update" method="POST" enctype="multipart/form-data">
                                      <div class="mb-3">
                                        ...
                                        <select name="category_id" hidden>
                                          <option value="1" selected>Activities</option>
                          ...
                          <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#actDeleteModal-<?php echo $post["id"]; ?>">
                          Delete
                          </button>

                          <!-- delete user modal -->
                          <div class="modal fade" id="actDeleteModal-<?php echo $post["id"]; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
